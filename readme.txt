...
(1) In the "roman_numeral_kata" directory, double-click the ".sln" file to open the solution with Microsoft Visual Studio 2012 (other versions will likely also work).
